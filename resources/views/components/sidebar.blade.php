...
<style>
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" @switch(Auth::user()->level)
        @case('ADMIN')
        href="{{ route('admin') }}"
        @break
        @case('DOKTER')
        ...
        @endswitch>
        <div class="">
            <img src="{{ asset('themes/admin/img/logo_sipandu.jpg') }}" class="sidebar-logo" alt="">
            {{-- <i class="fas fa-hospital"></i> --}}
        </div>
        <div class="sidebar-brand-text px-2">Sipandu</div>
    </a>
    ...
    @endif
    @if (Auth::user()->level == 'DOKTER' || Auth::user()->level == 'ADMIN' || Auth::user()->level == 'DESA')
    <!-- Divider -->
    ...
    <div class="sidebar-heading">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('ibu-hamil.index') }}">Form Ibu Hamil</a>
                <a class="collapse-item" href="{{route('registrasi-bayi.index')}}">Registrasi Bayi</a>
                <a class="collapse-item" href="{{route('registrasi-balita.index')}}">Registrasi Balita</a>
            </div>
        </div>
    </li>
    ...
    {{-- <li class="nav-item {{ strpos(Route::currentRouteName(), 'desa.index') === 0 ? 'active' : '' }}">
    <a class="nav-link" href="{{ route('desa.index') }}">
        <i class="fas fa-fw fa-hospital-user"></i>
        <span>Desa</span></a>
    </li> --}}

    {{-- <li class="nav-item {{ strpos(Route::currentRouteName(), 'bayi.index') === 0 ? 'active' : '' }}">
